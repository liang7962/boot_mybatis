...
//            concatPDFs(pdfs, output, true);
        	...
        	//ProcessPDF.addPdfImgMark("E:\\file2\\1502349579058.pdf","E:\\file2" + File.separator + "mark" + File.separator + "mark1111upGRAY.pdf", "C:\\Users\\Administrator\\Desktop\\1127.png",300,350);
        	ProcessPDF.addPdfTextMark("E:\\2018.pdf", "E:\\2018-1.pdf", "www.hnkxyq.com", 300,350);
        	System.out.println("====================");
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//		}  
	...
	public static void addPdfTextMark(String InPdfFile, String outPdfFile, String textMark,int textWidth,  
		...
		for(int i = 1; i <= pageSize; i++) {  
			...
			// under = stamp.getOverContent(i);//水印在之前文本上
			under.beginText();  
			under.setColorFill(BaseColor.LIGHT_GRAY);// 文字水印 颜色
			under.setFontAndSize(font, 70);// 文字水印 字体及字号
			under.setGState(gs1);
